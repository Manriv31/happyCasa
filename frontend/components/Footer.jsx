        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
              <li>
                <a href="https://www.facebook.com/profile.php?id=61557513656362" className="text-white transition hover:text-brand-yellow" target="_blank" rel="noopener noreferrer">
              ...
              <li>
                <a href="https://www.instagram.com/officialhappycasa" className="text-white transition hover:text-brand-yellow" target="_blank" rel="noopener noreferrer">
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-2 lg:col-span-2 md:grid-cols-4">
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-8 space-y-4 text-sm">
                <li><a className="text-blue-100 transition hover:text-brand-yellow" href="/about">About Us</a></li>
                <li><a className="text-blue-100 transition hover:text-brand-yellow" href="/services">Services</a></li>
                <li><a className="text-blue-100 transition hover:text-brand-yellow" href="/projects">Past Projects</a></li>
                <li><a className="text-blue-100 transition hover:text-brand-yellow" href="/contact">Contact Us</a></li>
              </ul>
            </div>
              ...
              <ul className="mt-8 space-y-4 text-sm">
                ...
                <li>
                  <a className="flex items-center justify-center gap-1.5 sm:justify-start" href="mailto:info@happycasa.com">
                    ...
                    <span className="text-blue-100">info@hellohappycasa.com</span>
                  </a>
                </li>
              </ul>
            </div>
